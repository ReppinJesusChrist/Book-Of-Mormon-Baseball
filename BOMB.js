import {ELS, ANIMATION_TIME_MS, GAME_STATES, BASE_POSITIONS,
  DIFFICULTY_NAMES, BOOK_NAMES} from './config.js'
import { gameState, endGame, addStrike, startRound, 
...
import {populateIncludeExcludeOptions, populateGuessOptions, updateScoreboard,
  hideGameOver, initializeLBTableRows, updateLBDisplayDifficulty,
  updateLBTableRows, updateLBDisplayBook, showScreen, positionBases,
} from "./ui_manager.js";
...
async function handleVSelectChange(){
